...
- Open index.js with Notepad++, look at line 2 (`let api = ""`), paste your osu!API key inside the quotes and the save the file.
...
> #### **0.0.1**
> - Top elements: Score, Accuracy, HP Bar, Avatar, Username, Country, Rank, PP
